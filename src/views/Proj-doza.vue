                ...
                <div class="product-details__inner">
                  <div class="product-details__main-content">
                    <div class="product-details__text-inner--sm">
                      <h3 class="product-details__title product-details__title--sm"> Обучающее приложение</h3>
                      <p class="product-details__text product-details__text--mt">Обучающее приложение для фармацевтов, провизоров, студентов медицинских и фармацевтический учебных заведений.</p>
                    </div>
                  </div>
                </div>
                <div class="capitalize">
                  <div class="capitalize__item"> doza </div>
                </div>
                <div class="cards__inner">
                  <div class="cards">
                    <div class="cards__item">
                      <picture><img src="../img/cards/doza1.jpg" srcset="../img/cards/doza1@2x.jpg 2x" alt="" /></picture>
                    </div>
                    <div class="cards__item">
                      <picture><img src="../img/cards/doza2.jpg" srcset="../img/cards/doza2@2x.jpg 2x" alt="" /></picture>
                    </div>
                  </div>
                </div>
              </div>
              <div class="product-details__inner">
                <div class="product-details__main-content">
                  <div class="product-details__text-inner">
                    <h3 class="product-details__title">О проекте<span class="product-details__title--red"> DOZA</span></h3>
                    <p> DoZa - это обучающее приложение, специально разработанное для фармацевтов, провизоров, студентов медицинских и фармацевтический учебных заведений, с учетом всех особенностей профессии.
                    </p>
                    <p> Чтобы поддерживать свою экспертность, фармработнику важно постоянно учиться.
                    </p>
                    <p> А так как это требует большого количества времени, денег, а порой и собственных выходных, это не всегда получается.
                    </p>
                    <p> Приложение ДОЗА решает задачу с самообразованием эффективно, быстро, удобно и без отрыва от производства.
                    <div class="product-details__text product-details__text-item"> Как проходит обучение:
                      <p> – На главной странице экрана вы сможете выбрать нужный вам раздел.</p>
                      <p> – После этого перед вами откроются видео-уроки, продолжительностью не более 3х минут. Никакой воды, все самое главное и важное в нескольких минутах;</p>
                      <p> - После просмотра урока вам предложат закрепить знания в интересной игровой форме. Игры будут разноплановые, вам точно не будет скучно;</p>
                      <p> - Каждый правильный ответ позволит вам накопить опыт, заработать деньги, открыть новый уровень в игре.</p>
                    </div>
                    </p>
                  ...
                  <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides glide-details__slides">
                      <li class="glide__slide glide-details__slide">
                        <picture><img src="../img/product-details/doza1.jpg" srcset="../img/product-details/doza1@2x.jpg 2x" alt="" /></picture>
                      </li>
                      <li class="glide__slide glide-details__slide">
                        <picture><img src="../img/product-details/doza2.jpg" srcset="../img/product-details/doza2@2x.jpg 2x" alt="" /></picture>
                      </li>
                      <li class="glide__slide glide-details__slide">
                        <picture><img src="../img/product-details/doza3.jpg" srcset="../img/product-details/doza3@2x.jpg 2x" alt="" /></picture>
                      </li>
                    </ul>
                  </div>
